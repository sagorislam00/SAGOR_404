...
const nam = [{
    ...
    message: ['~এখন দুপুর ২টা বাজে গোসল করে সবাই দুপুরের খাবার খেয়ে নাও ☺️']
						 ...
						 {
    timer: '4:00:00 PM',
    message: ['~এখন দুপুর ৩টা বাজে আসো free fire খালি❤️']
},
						{
    timer: '5:00:00 PM',
    ...
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই এখন এশার আযান দিবে সবাই নামাজ পড়ে নাও❤️']
             ...
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে পড়ালেখা শেষ করে খাইতে যাও🥴']
},
             {
    timer: '10:00:00 PM',
    message: ['এখন রাত ৯টা বাজে কিস পটিস করার চিন্তা থাকলে বিয়া কর🙂']
},
            {
    timer: '11:00:00 PM',
    message: ['~এখন রাত ১০টা বাজে সবাই ঘুমায় পড়ো সাগর বসের বউ নাই ভাই ঘুমাবে না😭']
}];
